...
Plans:
- [x] 03-01-PLAN.md — Utility extensions (SimpleViT, get_gpu_capability) + AMP training tutorial
- [x] 03-02-PLAN.md — BF16 vs FP16 comparison + FP8 Transformer Engine tutorial
